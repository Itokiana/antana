    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><span class="badge"><?php echo $p->stock; ?></span></td>
          <td>
          <a href="<?php echo base_url(); ?>products/<?php echo $p->id; ?>/show" class="btn btn-success btn-sm">Détails</a>
            <a href="<?php echo base_url(); ?>products/<?php echo $p->id; ?>" class="btn btn-primary btn-sm">Modifer</a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="<?php echo base_url(); ?>product/<?php echo $p->id; ?>"  class="btn btn-danger">Supprimer</a>
              </div>
            </div><!-- /.modal-content -->
          </div><!-- /.modal-dialog -->
        </div><!-- /.modal -->
