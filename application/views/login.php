...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/dashboard/css/flag-icon.min.css">
...
<body class="bg-dark">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <img class="align-content" src="<?php echo base_url();?>/assets/images/icons/logo.png" alt="">
                    </a>
                </div>
    ...
    <script src="<?php echo base_url();?>assets/dashboard/js/vendor/jquery-2.1.4.min.js"></script>
